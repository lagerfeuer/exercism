defmodule Frequency do
  ...
  defp count_letters(<<first::utf8, rest::binary>>, frequencies)
       when <<first::utf8>> in @ignore,
       do: count_letters(rest, frequencies)

  defp count_letters(<<first::utf8, rest::binary>>, frequencies) do
    count_letters(rest, Map.update(frequencies, String.downcase(<<first::utf8>>), 1, &(&1 + 1)))
  end
